...
%\IEEEpeerreviewmaketitle
 \textbf{11.16.3.7 - }A fair coin is tossed four times, and a person win Rs 1 for each head and lose
...
\\\\\textbf{Solution:}
  \begin{table}[htbp]
  \caption{Defining Random variable X and Y }
  \input{tables/table3.tex}
  \label{}
  \end{table}
 \\X $\sim$ B(4, p)
 \\p = Probability of head = $\frac{1}{2}$
 \\Profit for each head recieved = Rs 1
 \\Loss for each tail received = Rs 1.5
 \\\\
 \begin{table}[htbp]
 \input{tables/table2.tex}
 \label{}
 \end{table}
 \\\\So there can be 5 different amounts of money.
